...
mvn --batch-mode -f integrations/standalone/tests/integration/projects/dataclass-test-project/pom.xml versions:set versions:commit -DnewVersion=${1}
mvn --batch-mode -f integrations/standalone/tests/integration/projects/pom.xml versions:set versions:commit -DnewVersion=${1}
